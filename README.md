...
- Full Stack Mobile Application for tracking Calories and Nutrition Facts with Barcode reader -> [BACKEND_CODE](https://github.com/Svobyyy/mobileBackEnd).

[video](https://youtu.be/_ITC-0A5-lE?si=QQJqjckrvrD-pvgf)
